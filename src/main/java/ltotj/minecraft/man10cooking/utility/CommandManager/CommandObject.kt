package ltotj.minecraft.man10cooking.utility.CommandManager
...
class CommandObject{
    ...
    fun getExplanation():String{
        ...
        message.append(" §e${if(arguments.isNotEmpty()&&arguments.size==1) arguments[0] else getArgument().toString()}")
